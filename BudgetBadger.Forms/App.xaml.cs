...
namespace BudgetBadger.Forms
{
    public partial class App : PrismApplication
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigationOnIdiom<AccountsPage, AccountsPageViewModel>(desktopView: typeof(AccountsPage), tabletView: typeof(AccountsDetailedPage));
