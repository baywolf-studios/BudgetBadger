...
{
    public class ScheduledTransactionEditPageViewModel : ObservableBase, INavigationAware, IInitializeAsync
    {
        ...
        public ScheduledTransactionEditPageViewModel(IResourceContainer resourceContainer,
