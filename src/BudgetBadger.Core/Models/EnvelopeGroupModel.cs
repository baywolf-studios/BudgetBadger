...
{
    public class EnvelopeGroupModel : ObservableBase, IDeepCopy<EnvelopeGroupModel>, IEquatable<EnvelopeGroupModel>, IComparable, IComparable<EnvelopeGroupModel>
    {
        Guid id;
        public Guid Id
        {
        ...
        public bool IsGenericHiddenEnvelopeGroup { get => Id == Constants.GenericHiddenEnvelopeGroupId; }
        ...
        public EnvelopeGroupModel DeepCopy()
        {
            var group = (EnvelopeGroupModel)this.MemberwiseClone();
        ...
        public bool Equals(EnvelopeGroupModel p)
        {
        ...
        {
            return this.Equals(obj as EnvelopeGroupModel);
        }
        ...
        {
            return CompareTo(obj as EnvelopeGroupModel);
        }

        public int CompareTo(EnvelopeGroupModel group)
        {
            if (group is null)
            {
                return 1;
