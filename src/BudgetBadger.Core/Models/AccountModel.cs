...
{
    public class AccountModel : ObservableBase, IDeepCopy<AccountModel>, IEquatable<AccountModel>, IComparable, IComparable<AccountModel>
    {
        Guid id;
        public Guid Id
        {
        ...
        public AccountModelType Type
        {
            get => OnBudget ? AccountModelType.AccountTypeBudget : AccountModelType.AccountTypeReporting;
            set
            {
                OnBudget = value == AccountModelType.AccountTypeBudget;
            }
        }
        ...
        public bool IsGenericHiddenAccount { get => Id == Constants.GenericHiddenAccountId; }
        ...
        public AccountModel DeepCopy()
        {
            AccountModel account = (AccountModel)this.MemberwiseClone();
        ...
        public bool Equals(AccountModel p)
        {
        ...
        public int CompareTo(AccountModel account)
        {
            if (account is null)
            {
                return 1;
        ...
        {
            return CompareTo(obj as AccountModel);
        }
    }
}
