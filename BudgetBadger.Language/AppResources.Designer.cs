...
namespace BudgetBadger.Language {
    ...
    public class AppResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Due to recent Dropbox changes, you need to re-enable Cloud Sync via the Settings Page. Would you like to do that now?.
        /// </summary>
